...
public class TransferirDto {
    ...
    @Positive(message="O identificador da conta remetente não pode ser menor ou igual a 0 (zero)")
    private Long contaRemetenteId;

    @NotNull(message = "O identificador da conta favorecida não pode ser nulo")
    @Positive(message="O identificador da conta favorecida não pode ser menor ou igual a 0 (zero)")
